...
#ifndef __EVE_COMM_H__
#define __EVE_COMM_H__
...
#define _DATA_BUFSIZE_       20  //因为我要先收包头，我希望定义一个固定大小的数组专门用来收包头，这个数字大小一定要 >sizeof(comm_pkg_head_t) ,所以我这里定义为20绰绰有余；
                                  //如果日后comm_pkg_head_t大小变动，这个数字也要做出调整以满足 >sizeof(comm_pkg_head_t) 的要求
...
//一些和网络通讯相关的结构放在这里
//包头结构
typedef struct _comm_pkg_head_t
{
